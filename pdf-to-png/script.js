...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initConvertUI() {
        ...
        convertBtn.innerHTML = '<i class="fa-regular fa-image"></i> Convert to PNG';
    ...
    async function executeConversion() {
        ...
        try {
            ...
            // 3. Render each page to Canvas, then to PNG Blob
            for (let i = 1; i <= totalPages; i++) {
                ...
                // Convert canvas to PNG blob (PNG is natively lossless, no quality param needed)
                ...
                zip.file(`Page_${paddedNumber}.png`, blob);
            }
            ...
            const finalFileName = `PDFase_${baseName}_PNGs.zip`;
                ...
                actionContainer.innerHTML = `
                    ...
                    <div class="file-flow">
                        ...
                        <span style="display: block; width: 100%; margin-top: 5px; color: var(--text-muted); font-size: 0.8rem;">
                            Extracted ${totalPages} lossless PNG(s)
                        </span>
                    </div>
