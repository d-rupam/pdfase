...
(function initEnvironment() {
    ...
    style.innerHTML = `
        ...
        .action-container { margin-top: 1.2rem !important; margin-bottom: 3rem; display: none; gap: 0.5rem; justify-content: center; flex-direction: column; align-items: center; }
