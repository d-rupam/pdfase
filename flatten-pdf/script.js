...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initFlattenUI() {
        ...
        actionBtn.innerHTML = '<i class="fa-solid fa-file-shield"></i> Flatten PDF';
        actionBtn.addEventListener('click', executeFlattening);
    ...
    async function executeFlattening() {
        ...
        try {
            ...
            const finalFileName = `PDFase_${baseName}_Flattened.pdf`;
            ...
            setTimeout(() => {
                ...
                actionContainer.innerHTML = `
                    <div class="success-message">
                        <i class="fa-solid fa-circle-check"></i> PDF Flattened Successfully!
                    </div>
                    <div class="file-flow">
                    ...
                    <div class="button-group" style="margin-top: 5px;">
                        <a href="${url}" download="${finalFileName}" class="btn-action">
                            <i class="fa-solid fa-download"></i> Download Flattened PDF
                        </a>
                        <button type="button" class="btn-secondary" onclick="resetTool()">
                            <i class="fa-solid fa-rotate-right"></i> Flatten Another
                        </button>
                    </div>
                    ${stealthAttribution}
                `;
            ...
            alert('A critical error occurred while flattening the PDF document.');
